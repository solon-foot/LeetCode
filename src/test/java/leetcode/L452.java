...
public class L452 {
    ...
    public void test() {
        ...
        assertEquals(1, solution.findMinArrowShots(new int[][]{{1,2}}));
        assertEquals(1, solution.findMinArrowShots(new int[][] {{2,3},{2,3}}));
        assertEquals(2, solution.findMinArrowShots(new int[][] {{3,9},{7,12},{3,8},{6,8},{9,10},{2,9},{0,9},{3,9},{0,6},{2,8}}));
    }
