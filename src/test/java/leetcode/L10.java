...
public class L10 {
    ...
    public void test() {
        ...
        assertEquals(false, solution.isMatch("mississippi",""));
        assertEquals(false, solution.isMatch("","a"));
        assertEquals(true, solution.isMatch("",""));
        assertEquals(true, solution.isMatch("","a*"));
        assertEquals(true, solution.isMatch("abcef","a.*ef"));
        assertEquals(false, solution.isMatch("abcef","a.*e"));
        assertEquals(true, solution.isMatch("abcdef",".*b*a*def"));
